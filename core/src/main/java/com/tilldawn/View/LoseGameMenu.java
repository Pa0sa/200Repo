...
public class LoseGameMenu implements Screen {
    ...
    private LoseGameController controller;
    private Label label;
    ...
    public LoseGameMenu(GameController controller ,Skin skin) {
        this.stage = new Stage();
        this.controller = new LoseGameController();
        this.controller2 = controller;
        this.label = new Label("YOU DIED", skin);
    ...
    public LoseGameController getController() {
        return controller;
    }

    public void setController(LoseGameController controller) {
